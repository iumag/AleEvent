...
export class PhotographerPage {
    ...
    openModal(characterNum) {
     ...
     ngOnInit() {
        ...
        this.httpService.getData('http://10.100.3.68/api/photographer?column=sort&direction=asc&page=1&search_column=city_id&search_operator=equal_to&search_query_1=2&search_query_2=')
